...
<body>
  ...
  function showSupp(){
    ...
    while($hasil=queryTable($query)){
      ...
      <tr>
        ...
        <td><?php echo $mail?></td>
        <td class=addr><?php echo $addr?></td>
        <td>
          <a href="suppedit.php?id=<?php echo $id?>" class="btn btn-primary">Edit</a>
          <a href="suppdetail.php?id=<?php echo $id?>" class="btn btn-info">Detail</a>
        </td>
      </tr>
      <?php
    }
  ...
  <div class="container">
    ...
    <div class=text-right>
      <a href="newsupp.php" class="btn btn-primary">New Supplier</a>
    </div>
