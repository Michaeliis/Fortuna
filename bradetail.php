...
if(isset($_SESSION['empId'])){
  ...
  <head>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
      <script>
          function del(){
              var stat=confirm("Are you sure you want to delete this branch?");
              if(stat){
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="col-sm-9">
            ...
            <a href="mancust.php"><button class='btn' style="font-size:20px">Back</button></a>
        </div>
    </div>
  </body>
  </html>
