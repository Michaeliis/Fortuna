...
if(isset($_SESSION['empId'])){
  ...
  <body>
    ...
    <div class="container">
        <div class="col-sm-3">
            <img src="images/user/<?php echo $photo?>" style="width:100%">
        </div>
        <div class="col-sm-9">
            ...
            <a href="empedit.php?id=<?php echo $id ?>"><button class='btn btn-primary' style="font-size:20px">Edit</button></a>
            <button class='btn btn-danger' style="font-size:20px" onclick="del()">Remove</button>
            <a href="manemployee.php"><button class='btn' style="font-size:20px">Back</button></a>
        </div>
    </div>
  </body>
  </html>
